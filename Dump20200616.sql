...
CREATE TABLE `access` (
  ...
  CONSTRAINT `fk_accessuser` FOREIGN KEY (`user_email_address`) REFERENCES `user` (`email_address`)
...
CREATE TABLE `contact` (
  ...
  KEY `fk_contactuser` (`user_email_address`),
  CONSTRAINT `fk_contactuser` FOREIGN KEY (`user_email_address`) REFERENCES `user` (`email_address`)
...
CREATE TABLE `owner` (
  ...
  `owner_name` varchar(45) CHARACTER SET latin1 NOT NULL,
  `user_email_address` varchar(100) NOT NULL,
  PRIMARY KEY (`owner_id`),
  KEY `fk_owneruser` (`user_email_address`),
  CONSTRAINT `fk_owneruser` FOREIGN KEY (`user_email_address`) REFERENCES `user` (`email_address`)
...
CREATE TABLE `tenant` (
  ...
  KEY `fk_tenantuser` (`user_email_address`),
  CONSTRAINT `fk_tenantowner` FOREIGN KEY (`owner_owner_id`) REFERENCES `owner` (`owner_id`),
  CONSTRAINT `fk_tenantuser` FOREIGN KEY (`user_email_address`) REFERENCES `user` (`email_address`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-06-16 20:25:03
